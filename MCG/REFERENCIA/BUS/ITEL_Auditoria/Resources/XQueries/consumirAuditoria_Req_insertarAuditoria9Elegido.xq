...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../Schemas/BD_ITEL_INSERTARAUDITORIA9ELEGIDO.xsd" ::)

declare namespace ns1 = "http://www.comcel.com.co/AuditoriaITEL/";
declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/ITELSOA/PKG_SOA_ITEL/PRC_INSERT_AUDITORIA_9ELEGIDO/";
declare namespace xf = "http://tempuri.org/ITEL_Auditoria/Resources/XQueries/consumirAuditoria_Req_insertarAuditoria9Elegido/";

declare function xf:consumirAuditoria_Req_insertarAuditoria9Elegido($uuid as xs:decimal,
    ...
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            ...
            <ns0:P_COBRO>{ data($mensajeAuditoria/PARAMETROS_TRAMA/PARAMETRO[NOMBRE='BONIFICAR']/VALOR) }</ns0:P_COBRO>
        </ns0:InputParameters>
};
...
xf:consumirAuditoria_Req_insertarAuditoria9Elegido($uuid,
    $mensajeAuditoria)