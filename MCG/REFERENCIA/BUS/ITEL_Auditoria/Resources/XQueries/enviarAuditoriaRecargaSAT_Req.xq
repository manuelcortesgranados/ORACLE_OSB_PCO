...
(:: pragma bea:global-element-return element="ns0:Input_Parameters" location="../Schemas/MS_ITEL_AUDITORIARECARGASAT.xsd" ::)

declare namespace ns0 = "http://www.comcel.com.co/AuditoriaITEL/";
declare namespace xf = "http://tempuri.org/ITEL_Auditoria/Resources/XQueries/enviarAuditoriaRecargaSAT_Req/";

declare function xf:enviarAuditoriaRecargaSAT_Req($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:enviarAuditoriaRecargaSAT_Req($input_Parameters1)
