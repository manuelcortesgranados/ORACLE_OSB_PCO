(:: pragma bea:global-element-parameter parameter="$input_Parameters1" element="ns3:Input_Parameters" location="../../../../../RulesEngine/Amdocs/Resources/Schemas/PS_GET_IMEISTATUSAMDOCS.xsd" ::)
(:: pragma bea:global-element-return element="ns3:WS_Result" location="../../../../../RulesEngine/Amdocs/Resources/Schemas/PS_GET_IMEISTATUSAMDOCS.xsd" ::)
...
declare namespace ns3 = "http://www.claro.com.co/rulesEngine/getImeiStatusAmdocs";
declare namespace ns0 = "http://www.claro.com.co/rulesEngine/canonicalModel/SupplierDomain";
declare namespace xf = "http://tempuri.org/RulesEngine/Dummies/Resources/XQueries/getImeiStatusAmdocs_Res/";

declare function xf:getImeiStatusAmdocs_Res($input_Parameters1 as element(ns3:Input_Parameters))
...
xf:getImeiStatusAmdocs_Res($input_Parameters1)
