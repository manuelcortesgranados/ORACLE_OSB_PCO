...
(:: pragma bea:global-element-return element="ns4:WS_Result" location="../Schemas/PS_GET_STATUSICCIDSRM.xsd" ::)
...
declare namespace xf = "http://tempuri.org/RulesEngine/Amdocs/Resources/XQueries/getStatusIccidSrm_Res/";

declare function xf:getStatusIccidSrm_Res($getSerialStateInformationResponse1 as element(ns0:GetSerialStateInformationResponse),
    $input_Parameters1 as element(ns4:Input_Parameters))
    as element(ns4:WS_Result) {
        <ns4:WS_Result>
        	{
          	if(data($getSerialStateInformationResponse1/ns1:P_STATUS_ICCID_ACTIVA = "-1")) then
          		<code>203</code>
          	else
          		<code>1</code>
...
xf:getStatusIccidSrm_Res($getSerialStateInformationResponse1,
    $input_Parameters1)
