(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision" element="ns0:callFunctionStatelessDecision" location="../WSDLs/trama601Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA601.xsd" ::)

declare namespace ns2 = "http://www.comcel.com.co/CalcularProvisionTrama601/";
declare namespace ns1 = "http://www.comcel.com.co/Ejecutador/";
declare namespace ns0 = "http://xmlns.oracle.com/Trama601Provision/Trama601Provision_DF_Trama601Provision";
declare namespace xf = "http://tempuri.org/ITEL/Trama601/Resources/XQueries/calcularProvisionTrama601_Res/";

declare function xf:calcularProvisionTrama601_Res($callFunctionStatelessDecision as element(ns0:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama601_Res($callFunctionStatelessDecision)