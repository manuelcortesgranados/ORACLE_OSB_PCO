(:: pragma bea:global-element-parameter parameter="$input_Parameters" element="ns1:Input_Parameters" location="../Schemas/PS_ITEL_REGISTRAR_SMSELEGIDOS.xsd" ::)
(:: pragma bea:global-element-return element="ns0:RegistrarSMSElegidosRequest" location="../Schemas/DA_ITEL_OPERACION_CORBA.xsd" ::)
...
declare function xf:registrarSMSElegidosIN_Req_ejecutarOperacionIN($input_Parameters as element(ns1:Input_Parameters))
    as element(ns0:RegistrarSMSElegidosRequest) {
        <ns0:RegistrarSMSElegidosRequest cuenta = "{ data($input_Parameters/CUENTA) }"
        ...
        </ns0:RegistrarSMSElegidosRequest>
};
