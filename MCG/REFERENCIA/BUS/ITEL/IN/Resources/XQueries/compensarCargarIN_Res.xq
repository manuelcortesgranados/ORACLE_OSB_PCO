...
declare namespace xf = "http://tempuri.org/ITEL/IN/Resources/XQueries/compensarCargarIN_Res/";

declare function xf:compensarCargarIN_Res($compensacionResponse1 as element(ns0:CompensacionResponse),
    $codigo as xs:string,
...
xf:compensarCargarIN_Res($compensacionResponse1,
    $codigo,
    $descripcion)