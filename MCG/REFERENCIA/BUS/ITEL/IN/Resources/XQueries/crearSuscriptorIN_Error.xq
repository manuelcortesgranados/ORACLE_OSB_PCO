...
declare namespace xf = "http://tempuri.org/ITEL/IN/Resources/XQueries/crearSuscriptorIN_Error/";

declare function xf:crearSuscriptorIN_Error($codigo as xs:string,
...
xf:crearSuscriptorIN_Error($codigo,
    $mensaje,
    $descripcion)