...
(:: pragma bea:global-element-return element="ns0:ModificarSMSElegidosRequest" location="../Schemas/DA_ITEL_OPERACION_CORBA.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/IN/Resources/XQueries/modificarSMSElegidosIN_Req_ejecutarOperacionIN/";

declare function xf:modificarSMSElegidosIN_Req_ejecutarOperacionIN($input_Parameters as element(ns1:Input_Parameters))
    as element(ns0:ModificarSMSElegidosRequest) {
        <ns0:ModificarSMSElegidosRequest cuenta = "{ data($input_Parameters/CUENTA) }"
        ...
        </ns0:ModificarSMSElegidosRequest>
};

declare variable $input_Parameters as element(ns1:Input_Parameters) external;

xf:modificarSMSElegidosIN_Req_ejecutarOperacionIN($input_Parameters)