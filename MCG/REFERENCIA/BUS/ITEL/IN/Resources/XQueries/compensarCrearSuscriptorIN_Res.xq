...
declare namespace xf = "http://tempuri.org/ITEL/IN/Resources/XQueries/compensarCrearSuscriptorIN_Res/";
...
declare function xf:compensarCrearSuscriptorIN_Res($compensacionResponse1 as element(ns0:CompensacionResponse),
    $codigo as xs:string,
...
xf:compensarCrearSuscriptorIN_Res($compensacionResponse1,
    $codigo,
    $descripcion)