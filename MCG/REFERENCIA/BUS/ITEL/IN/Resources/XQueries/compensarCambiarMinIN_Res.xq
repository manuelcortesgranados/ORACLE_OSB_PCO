...
(:: pragma bea:global-element-return element="ns1:WS_Result" location="../Schemas/PS_ITEL_COMPENSAR_CAMBIARMIN.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/IN/Resources/XQueries/compensarCambiarMinIN_Res/";

declare function xf:compensarCambiarMinIN_Res($compensacionResponse1 as element(ns0:CompensacionResponse),
    $codigo as xs:string,
...
xf:compensarCambiarMinIN_Res($compensacionResponse1,
    $codigo,
    $descripcion)