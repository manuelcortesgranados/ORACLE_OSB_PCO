...
(:: pragma bea:global-element-parameter parameter="$input_Parameters1" element="ns3:Input_Parameters" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA100.xsd" ::)
(:: pragma bea:global-element-return element="ns1:callFunctionStateless" location="../WSDLs/trama100Provision_DB.wsdl" ::)

declare namespace xf = "http://tempuri.org/ITEL/Trama100/Resources/XQueries/calcularProvisionTrama100_Req/";
declare namespace ns2 = "http://xmlns.oracle.com/bpel";
declare namespace ns1 = "http://xmlns.oracle.com/Trama100Provision/Trama100Provision_DF_Trama100Provision";
declare namespace ns3 = "http://www.comcel.com.co/CalcularProvisionTrama100/";
...
declare function xf:calcularProvisionTrama100_Req($input_Parameters1 as element(ns3:Input_Parameters))
    as element(ns1:callFunctionStateless) {
        <ns1:callFunctionStateless name="Trama100Provision_DF_Trama100Provision">
          <ns1:parameterList>
          <ns0:TRAMA_EJECUCION>
                <ns0:MIN>{ xs:decimal($input_Parameters1/*:MIN) }</ns0:MIN>
                	{if($input_Parameters1/CODIGOIN<51)then
	                    <ns0:PARAMETROSNEGOCIO>
	                        ...
	                        <ns0:PAQUETESMWELCOME>{""}</ns0:PAQUETESMWELCOME>
	                    </ns0:PARAMETROSNEGOCIO>
                    else
	                    <ns0:PARAMETROSNEGOCIO>
	                        ...
	                        <ns0:PAQUETESMWELCOME>{$input_Parameters1/PARAMETROSTRAMA/PARAMETRO[NOMBRE='PAQUETESM_WELCOME']/VALOR/text()}</ns0:PAQUETESMWELCOME>
	                        <ns0:PAQUETESSM>{$input_Parameters1/PARAMETROSTRAMA/PARAMETRO[NOMBRE='MATERIALESRTC']/VALOR/text()}</ns0:PAQUETESSM>
	                    </ns0:PARAMETROSNEGOCIO>
                    }
...
xf:calcularProvisionTrama100_Req($input_Parameters1)