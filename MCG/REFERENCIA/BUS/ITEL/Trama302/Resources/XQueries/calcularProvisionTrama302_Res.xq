...
(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision1" element="ns2:callFunctionStatelessDecision" location="../WSDLs/trama302Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns1:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA302.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/Trama302/Resources/XQueries/calcularProvisionTrama302_Res/";
...
declare function xf:calcularProvisionTrama302_Res($callFunctionStatelessDecision1 as element(ns2:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama302_Res($callFunctionStatelessDecision1)