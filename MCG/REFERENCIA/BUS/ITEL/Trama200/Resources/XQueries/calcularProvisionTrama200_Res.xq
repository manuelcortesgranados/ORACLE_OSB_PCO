(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision" element="ns0:callFunctionStatelessDecision" location="../WSDLs/trama200Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA200.xsd" ::)

declare namespace ns2 = "http://www.comcel.com.co/CalcularProvisionTrama200/";
declare namespace ns1 = "http://www.comcel.com.co/Ejecutador/";
declare namespace ns0 = "http://xmlns.oracle.com/Trama200Provision/Trama200Provision_DF_Trama200Provision";
declare namespace xf = "http://tempuri.org/ITEL/Trama200/Resources/XQueries/calcularProvisionTrama200_Res/";

declare function xf:calcularProvisionTrama200_Res($callFunctionStatelessDecision as element(ns0:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama200_Res($callFunctionStatelessDecision)