...
(:: pragma bea:global-element-parameter parameter="$parametros" element="ns2:WS_Result" location="../Schemas/PS_ITEL_VALIDARTRAMA402.xsd" ::)
...
declare namespace ns2 = "http://www.comcel.com.co/ValidarTrama402/";
declare namespace ns1 = "http://www.comcel.com.co/DA_TRAMA";
declare namespace ns0 = "http://www.comcel.com.co/EjecutarReglasNegocio/";
declare namespace xf = "http://tempuri.org/ITEL/Trama402/Resources/XQueries/trama402_ejecutarReglasNegocioLocal_Req/";

declare function xf:trama402_ejecutarReglasNegocioLocal_Req($trama as element(ns1:TRAMA),
    ...
    as element(ns0:Input_Parameters) {
        <ns0:Input_Parameters>
            ...
            <MIN_DESTINO>{ concat($trama/ns1:MIN , $parametros/MENSAJE/MINDESTINO) }</MIN_DESTINO>
...
xf:trama402_ejecutarReglasNegocioLocal_Req($trama,
    $parametros,
    $indestino,
    $inorigen,
    $prefijo,
