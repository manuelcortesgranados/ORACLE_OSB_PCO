(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision" element="ns0:callFunctionStatelessDecision" location="../WSDLs/trama402Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA402.xsd" ::)

declare namespace ns2 = "http://www.comcel.com.co/CalcularProvisionTrama402/";
declare namespace ns1 = "http://www.comcel.com.co/Ejecutador/";
declare namespace ns0 = "http://xmlns.oracle.com/Trama402Provision/Trama402Provision_DF_Trama402Provision";
declare namespace xf = "http://tempuri.org/ITEL/Trama402/Resources/XQueries/calcularProvisionTrama402_Res/";

declare function xf:calcularProvisionTrama402_Res($callFunctionStatelessDecision as element(ns0:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama402_Res($callFunctionStatelessDecision)