(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision" element="ns0:callFunctionStatelessDecision" location="../WSDLs/trama400Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA400.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Trama400/Resources/XQueries/calcularProvisionTrama400_Res/";

declare function xf:calcularProvisionTrama400_Res($callFunctionStatelessDecision as element(ns0:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama400_Res($callFunctionStatelessDecision)