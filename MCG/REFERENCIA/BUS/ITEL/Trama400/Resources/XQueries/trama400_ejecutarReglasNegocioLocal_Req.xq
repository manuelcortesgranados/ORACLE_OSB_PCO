...
(:: pragma bea:global-element-parameter parameter="$parametros" element="ns2:WS_Result" location="../Schemas/PS_ITEL_VALIDARTRAMA400.xsd" ::)
...
declare namespace ns2 = "http://www.comcel.com.co/ValidarTrama400/";
declare namespace ns1 = "http://www.comcel.com.co/DA_TRAMA";
declare namespace ns0 = "http://www.comcel.com.co/EjecutarReglasNegocio/";
declare namespace xf = "http://tempuri.org/ITEL/Trama400/Resources/XQueries/trama400_ejecutarReglasNegocioLocal_Req/";

declare function xf:trama400_ejecutarReglasNegocioLocal_Req($trama as element(ns1:TRAMA),
...
xf:trama400_ejecutarReglasNegocioLocal_Req($trama,
    $parametros,
    $in,
    $prefijo,
    $tiempo,
