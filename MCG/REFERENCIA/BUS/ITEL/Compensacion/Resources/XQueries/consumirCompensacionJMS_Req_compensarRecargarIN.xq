...
(:: pragma bea:global-element-return element="ns0:Input_Parameters" location="../../../IN/Resources/Schemas/PS_ITEL_COMPENSAR_RECARGAR.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Compensacion/Resources/XQueries/consumirCompensacionJMS_Req_compensarRecargarIN/";

declare function xf:consumirCompensacionJMS_Req_compensarRecargarIN($servicio as element() , $fechaExpiracion as xs:string)
...
xf:consumirCompensacionJMS_Req_compensarRecargarIN($servicio, $fechaExpiracion)