...
(:: pragma bea:global-element-return element="ns0:Input_Parameters" location="../../../IN/Resources/Schemas/PS_ITEL_COMPENSAR_MODIFICARELEGIDOS_FIJOS.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Compensacion/Resources/XQueries/consumirCompensacionJMS_Req_compensarModificarElegidosFijosIN/";

declare function xf:consumirCompensacionJMS_Req_compensarModificarElegidosFijosIN($servicio as element())
    as element(ns0:Input_Parameters) {
        <ns0:Input_Parameters>
        	<PREFIX>{ data($servicio/PARAMETROS/PARAMETRO[NOMBRE='PREFIJO']/VALOR) }</PREFIX>
            ...
            <ELEGIDOS_ORIGINALES>{ $servicio/PARAMETROS/PARAMETRO[NOMBRE='ELEGIDOSORIGINALES']/VALOR/node() }</ELEGIDOS_ORIGINALES>
            <ELEGIDOS_REMOVER>{ $servicio/PARAMETROS/PARAMETRO[NOMBRE='ELEGIDOSREMOVER']/VALOR/node() }</ELEGIDOS_REMOVER>
            {
...
xf:consumirCompensacionJMS_Req_compensarModificarElegidosFijosIN($servicio)