...
(:: pragma bea:global-element-return element="ns0:Input_Parameters" location="../../../IN/Resources/Schemas/PS_ITEL_COMPENSAR_REGISTRARSMSELEGIDOS.xsd" ::)

declare namespace ns2 = "http://www.comcel.com.co/CompensacionITEL/";
declare namespace ns0 = "http://www.comcel.com.co/CompensarRegistrarSMSElegidosIN/";
declare namespace xf = "http://tempuri.org/ITEL/Compensacion/Resources/XQueries/consumirCompensacionJMS_Req_compensarRegistrarSMSElegidosIN/";

declare function xf:consumirCompensacionJMS_Req_compensarRegistrarSMSElegidosIN($servicio as element())
...
xf:consumirCompensacionJMS_Req_compensarRegistrarSMSElegidosIN($servicio)