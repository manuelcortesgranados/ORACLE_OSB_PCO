...
declare namespace xf = "http://tempuri.org/ITEL/Compensacion/Resources/XQueries/consumirCompensacionJMS_Req_ajustesAIR/";

declare function xf:consumirCompensacionJMS_Req_ajustesAIR($servicio as element())
...
xf:consumirCompensacionJMS_Req_ajustesAIR($servicio)