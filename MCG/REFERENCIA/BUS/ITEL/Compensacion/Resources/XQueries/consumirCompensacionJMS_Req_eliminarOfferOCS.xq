...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../OCS/AIR/Resources/Schemas/PS_ITEL_ELIMINAR_OFFER.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/Compensacion/Resources/XQueries/consumirCompensacionJMS_Req_eliminarOfferOCS/";
declare namespace ns0 = "http://www.comcel.com.co/CompensacionITEL/";
declare namespace ns1 = "http://www.comcel.com.co/EliminarOfferOCS/";

declare function xf:consumirCompensacionJMS_Req_eliminarOfferOCS($sERVICIO1 as element())
    as element(ns1:Input_Parameters) {
        <ns1:Input_Parameters>
            ...
            <OFFERID>{ data($sERVICIO1/PARAMETROS/PARAMETRO[NOMBRE='OFFERID']/VALOR) }</OFFERID>
        </ns1:Input_Parameters>
};

declare variable $sERVICIO1 as element() external;

xf:consumirCompensacionJMS_Req_eliminarOfferOCS($sERVICIO1)
