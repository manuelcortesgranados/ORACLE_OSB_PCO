...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../OCS/AIR/Resources/Schemas/PS_ITEL_ACTUALIZAR_OFFER_TYPE.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/Compensacion/Resources/XQueries/consumirCompensacionJMS_Req_actualizarOfferTypeOCS/";
...
declare function xf:consumirCompensacionJMS_Req_actualizarOfferTypeOCS($sERVICIO1 as element())
    as element(ns1:Input_Parameters) {
        <ns1:Input_Parameters>
            ...
            <OFFER_ID>{ data($sERVICIO1/PARAMETROS/PARAMETRO[NOMBRE='OFFER_ID']/VALOR) }</OFFER_ID>
...
xf:consumirCompensacionJMS_Req_actualizarOfferTypeOCS($sERVICIO1)
