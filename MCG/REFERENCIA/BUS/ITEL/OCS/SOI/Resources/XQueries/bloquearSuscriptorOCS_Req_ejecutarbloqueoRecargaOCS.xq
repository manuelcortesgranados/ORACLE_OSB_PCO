...
(:: pragma bea:global-element-return element="ns0:Input_Parameters" location="../../../AIR/Resources/Schemas/PS_ITEL_ACTUALIZAR_BLOQUEO_RECARGA.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/OCS/SOI/Resources/XQueries/bloquearSuscriptorOCS_Req_ejecutarbloqueoRecargaOCS/";

declare function xf:bloquearSuscriptorOCS_Req_ejecutarbloqueoRecargaOCS($input_Parameters1 as element(ns1:Input_Parameters))
    ...
    <ns0:Input_Parameters>
    	...
    	<ACCION>{ if(data($input_Parameters1/BLOQUEO_FRAUDE)="true") then "BAR" else "CLEAR" }</ACCION>
</ns0:Input_Parameters>
...
xf:bloquearSuscriptorOCS_Req_ejecutarbloqueoRecargaOCS($input_Parameters1)