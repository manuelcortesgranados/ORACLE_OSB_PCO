...
declare namespace xf = "http://tempuri.org/ITEL/OCS/SOI/Resources/XQueries/crearSuscriptorOCS_Req_ejecutarbloqueoTemporalOCS/";

declare function xf:crearSuscriptorOCS_Req_ejecutarbloqueoTemporalOCS($min as xs:string)
    ...
    <ns0:Input_Parameters>
	    ...
	    <MIN>{ concat("57" ,data($min)) }</MIN>
    	<FLAGBOQUEO>{ "1" }</FLAGBOQUEO>
</ns0:Input_Parameters>
...
xf:crearSuscriptorOCS_Req_ejecutarbloqueoTemporalOCS($min)