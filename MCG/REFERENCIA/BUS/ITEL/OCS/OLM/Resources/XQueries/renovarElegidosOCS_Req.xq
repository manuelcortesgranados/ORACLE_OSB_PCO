(:: pragma bea:global-element-parameter parameter="$input_Parameters1" element="ns0:Input_Parameters" location="../Schemas/PS_ITEL_RENOVAR_ELEGIDOS.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/OCS/OLM/Resources/XQueries/renovarElegidosOCS_Req/";

declare function xf:renovarElegidosOCS_Req($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:renovarElegidosOCS_Req($input_Parameters1)