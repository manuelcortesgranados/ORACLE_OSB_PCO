...
(:: pragma bea:global-element-parameter parameter="$input_Parameters1" element="ns2:Input_Parameters" location="../Schemas/PS_ITEL_CONSULTAR_OFFER_ODM.xsd" ::)
...
declare function xf:consultarOfferODM_Req($input_Parameters1 as element(ns2:Input_Parameters))
...
xf:consultarOfferODM_Req($input_Parameters1)