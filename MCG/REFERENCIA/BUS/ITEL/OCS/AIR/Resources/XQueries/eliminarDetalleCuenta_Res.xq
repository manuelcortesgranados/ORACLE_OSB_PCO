...
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_ELIMINAR_DETALLE_CUENTA.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/OCS/AIR/Resources/XQueries/eliminarDetalleCuenta_Res/";
declare namespace ns2 = "http://www.comcel.com.co/EliminarDetalleCuentaOCS/";
...
declare function xf:eliminarDetalleCuenta_Res($methodResponse1 as element(), $codigo as xs:string, $descripcion as xs:string)
    as element(ns2:WS_Result) {
        <ns2:WS_Result>
           <CODIGO>{ $codigo }</CODIGO>
           <MENSAJE>
                <ELIMINAR_DETALLE_CUENTA>
                   <MethodResponse>
...
xf:eliminarDetalleCuenta_Res($methodResponse1, $codigo, $descripcion)