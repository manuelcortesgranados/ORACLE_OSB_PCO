...
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_ACTUALIZAR_BLOQUEO_TEMPORAL.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/OCS/AIR/Resources/XQueries/actualizarBloqueoTemporal_Res/";
...
declare function xf:actualizarBloqueoTemporal_Res($methodResponse1 as element(), $codigo as xs:string, $descripcion as xs:string)
    as element(ns2:WS_Result) {
        <ns2:WS_Result>
           <CODIGO>{ $codigo }</CODIGO>
           <MENSAJE>
                <ACTUALIZAR_BLOQUEO_TEMPORAL>
                   <MethodResponse>
...
xf:actualizarBloqueoTemporal_Res($methodResponse1, $codigo, $descripcion)