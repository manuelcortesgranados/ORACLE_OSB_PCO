...
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_ACTUALIZAR_GENERAL.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/OCS/AIR/Resources/XQueries/actualizarGeneral_Res/";
...
declare function xf:actualizarGeneral_Res($methodResponse1 as element(), $codigo as xs:string, $descripcion as xs:string)
...
xf:actualizarGeneral_Res($methodResponse1, $codigo, $descripcion)