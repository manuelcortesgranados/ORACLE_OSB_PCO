...
declare namespace xf = "http://tempuri.org/ITEL/OCS/AIR/Resources/XQueries/eliminarOffer_Req/";
...
declare function xf:eliminarOffer_Req($input_Parameters1 as element(ns2:Input_Parameters))
...
xf:eliminarOffer_Req($input_Parameters1)