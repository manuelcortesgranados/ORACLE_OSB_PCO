...
(:: pragma bea:global-element-parameter parameter="$input_Parameters1" element="ns2:Input_Parameters" location="../Schemas/PS_ITEL_ACTUALIZAR_BLOQUEO_TEMPORAL.xsd" ::)
(:: pragma bea:global-element-return element="ns0:ActualizarBloqueoTemporalRequest" location="../Schemas/DA_ITEL_OPERACION_OCS_AIR.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/OCS/AIR/Resources/XQueries/actualizarBloqueoTemporal_Req/";
declare namespace ns2 = "http://www.comcel.com.co/ActualizarBloqueoTemporalOCS/";
...
declare function xf:actualizarBloqueoTemporal_Req($input_Parameters1 as element(ns2:Input_Parameters))
    as element(ns0:ActualizarBloqueoTemporalRequest) {
        <ns0:ActualizarBloqueoTemporalRequest>
	         <methodCall>
		                        ...
		                        <value>
		                            <struct>
		                                ...
		                                <member>
		                                    ...
		                                    <value>
		                                        <boolean>{ data($input_Parameters1/FLAGBOQUEO) }</boolean>
		                                    </value>
		                                </member>
		                            </struct>
		                        </value>
...
xf:actualizarBloqueoTemporal_Req($input_Parameters1)