...
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CONSULTAR_OFFER.xsd" ::)
                ...
                <CONSULTAR_OFFER>
                   ...
                   return 
                     <Detail>
                        ...
                        <offerID>{data($dedicatedStructs/member[name = "offerType"]/value)}</offerID>
                        <offerType>{data($dedicatedStructs/member[name = "offerID"]/value)}</offerType>
                     </Detail>
                   }
                   </offerInformationList>
                </CONSULTAR_OFFER>
