...
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_ELIMINAR_OFFER_ODM.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/OCS/AIR/Resources/XQueries/eliminarOfferODM_Res/";
...
declare function xf:eliminarOfferODM_Res($methodResponse1 as element(), $codigo as xs:string, $descripcion as xs:string)
...
xf:eliminarOfferODM_Res($methodResponse1, $codigo, $descripcion)