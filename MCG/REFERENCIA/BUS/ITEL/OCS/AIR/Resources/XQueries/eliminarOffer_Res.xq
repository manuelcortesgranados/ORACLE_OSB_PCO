...
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_ELIMINAR_OFFER.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/OCS/AIR/Resources/XQueries/eliminarOffer_Res/";
declare namespace ns2 = "http://www.comcel.com.co/EliminarOfferOCS/";
...
declare function xf:eliminarOffer_Res($methodResponse1 as element(), $codigo as xs:string, $descripcion as xs:string)
...
xf:eliminarOffer_Res($methodResponse1, $codigo, $descripcion)