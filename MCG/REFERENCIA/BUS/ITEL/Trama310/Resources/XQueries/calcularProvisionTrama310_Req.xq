(:: pragma bea:global-element-parameter parameter="$input_Parameters1" element="ns2:Input_Parameters" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA310.xsd" ::)
(:: pragma bea:global-element-return element="ns0:callFunctionStateless" location="../WSDLs/trama310Provision_DB.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Trama310/Resources/XQueries/calcularProvisionTrama310_Req/";
...
declare function xf:calcularProvisionTrama310_Req($input_Parameters1 as element(ns2:Input_Parameters))
    as element(ns0:callFunctionStateless) {
        <ns0:callFunctionStateless name="Trama310provision_DF_Trama310provision">
            <ns0:parameterList>
                <ns1:TRAMA_EJECUCION>
                ...
                <ns1:MIN_ELEGIDOS_FIJOS>{ xf:cargaElegidos( data($input_Parameters1/MIN_ELEGIDOS_FIJOS) ) }</ns1:MIN_ELEGIDOS_FIJOS>
                    ...
                    <ns1:PARAMETROSNEGOCIO>
                        <ns1:ACREDITACUENTA>{if ($input_Parameters1/PARAMETROSTRAMA/PARAMETRO[NOMBRE='BONIFICAR']/VALOR/text()="0") then "false" else "true"}</ns1:ACREDITACUENTA>
...
xf:calcularProvisionTrama310_Req($input_Parameters1)