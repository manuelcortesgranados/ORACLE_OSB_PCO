...
(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision1" element="ns1:callFunctionStatelessDecision" location="../WSDLs/trama303Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA303.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Trama303/Resources/XQueries/calcularProvisionTrama303_Res/";

declare function xf:calcularProvisionTrama303_Res($callFunctionStatelessDecision1 as element(ns1:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama303_Res($callFunctionStatelessDecision1)