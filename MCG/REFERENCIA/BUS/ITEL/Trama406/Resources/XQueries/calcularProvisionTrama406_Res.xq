(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision" element="ns0:callFunctionStatelessDecision" location="../WSDLs/trama406Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA406.xsd" ::)

declare namespace ns2 = "http://www.comcel.com.co/CalcularProvisionTrama406/";
declare namespace ns1 = "http://www.comcel.com.co/Ejecutador/";
declare namespace ns0 = "http://xmlns.oracle.com/Trama406Provision/Trama406Provision_DF_Trama406Provision";
declare namespace xf = "http://tempuri.org/ITEL/Trama406/Resources/XQueries/calcularProvisionTrama406_Res/";

declare function xf:calcularProvisionTrama406_Res($callFunctionStatelessDecision as element(ns0:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama406_Res($callFunctionStatelessDecision)