...
(:: pragma bea:global-element-parameter parameter="$input_Parameters1" element="ns2:Input_Parameters" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA304.xsd" ::)
(:: pragma bea:global-element-return element="ns1:callFunctionStateless" location="../WSDLs/trama304Provision_DB.wsdl" ::)

declare namespace xf = "http://tempuri.org/ITEL/Trama304/Resources/XQueries/calcularProvisionTrama304_Req/";
declare namespace ns2 = "http://www.comcel.com.co/CalcularProvisionTrama304/";
declare namespace ns1 = "http://xmlns.oracle.com/Trama304Provision/Trama304Provision_DF_Trama304Provision";
...
declare function xf:calcularProvisionTrama304_Req($input_Parameters1 as element(ns2:Input_Parameters))
    as element(ns1:callFunctionStateless) {
        <ns1:callFunctionStateless name="Trama304Provision_DF_Trama304Provision">
            <ns1:parameterList>
               <ns0:TRAMA_EJECUCION>
...
xf:calcularProvisionTrama304_Req($input_Parameters1)