...
(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision1" element="ns1:callFunctionStatelessDecision" location="../WSDLs/trama304Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA304.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/Trama304/Resources/XQueries/calcularProvisionTrama304_Res/";
...
declare function xf:calcularProvisionTrama304_Res($callFunctionStatelessDecision1 as element(ns1:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama304_Res($callFunctionStatelessDecision1)