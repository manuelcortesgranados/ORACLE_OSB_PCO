...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglasProvision_Req_CalcularProvTrama302Local/";

declare function xf:consultarReglasProvision_Req_CalcularProvTrama302Local($input_Parameters1 as element(ns0:Input_Parameters))
    as element(ns1:Input_Parameters) {
        <ns1:Input_Parameters>
            ...
            <MIN_ELEGIDO>{ data($input_Parameters1/PARAMETROSTRAMA/PARAMETRO[NOMBRE='HOSTID']/VALOR) }</MIN_ELEGIDO>
...
xf:consultarReglasProvision_Req_CalcularProvTrama302Local($input_Parameters1)