...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/ejecutador_Req_insertarElegidoIlimitadoOCS/";

declare function xf:ejecutador_Req_insertarElegidoIlimitadoOCS($min as xs:decimal,
...
xf:ejecutador_Req_insertarElegidoIlimitadoOCS($min,
    $elegido,
    $elegidoAntiguo,
    $fechaCreacion,
    $fechaExpiracion)