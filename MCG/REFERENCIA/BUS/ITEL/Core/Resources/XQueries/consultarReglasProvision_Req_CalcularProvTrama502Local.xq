...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama502/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA502.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglasProvision_Req_CalcularProvTrama502Local/";

declare function xf:consultarReglasProvision_Req_CalcularProvTrama502Local($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:consultarReglasProvision_Req_CalcularProvTrama502Local($input_Parameters1)