...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama302/Resources/Schemas/PS_ITEL_CONSULTARREGLASTRAMA302.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglas_Req_consultarReglasTrama302Local/";

declare function xf:consultarReglas_Req_consultarReglasTrama302Local($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:consultarReglas_Req_consultarReglasTrama302Local($input_Parameters1)