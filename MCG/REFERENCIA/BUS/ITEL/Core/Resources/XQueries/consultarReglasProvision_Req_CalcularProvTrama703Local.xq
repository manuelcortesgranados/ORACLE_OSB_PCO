...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama703/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA703.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglasProvision_Req_CalcularProvTrama703Local/";

declare function xf:consultarReglasProvision_Req_CalcularProvTrama703Local($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:consultarReglasProvision_Req_CalcularProvTrama703Local($input_Parameters1)