(:: pragma bea:global-element-parameter parameter="$wS_Result1" element="ns1:WS_Result" location="../../../Trama414/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA414.xsd" ::)
(:: pragma bea:global-element-return element="ns0:WS_Result" location="../Schemas/PS_ITEL_CONSULTARREGLASPROVISION.xsd" ::)

declare namespace ns1 = "http://www.comcel.com.co/CalcularProvisionTrama414/";
declare namespace ns0 = "http://www.comcel.com.co/ConsultarReglasProvision/";
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglasProvision_Req_CalcularProvTrama414Local/";

declare function xf:consultarReglasProvision_Req_CalcularProvTrama414Local($wS_Result1 as element(ns1:WS_Result),
    $tiempoI as xs:time)
...
xf:consultarReglasProvision_Req_CalcularProvTrama414Local($wS_Result1,
    $tiempoI)