...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama101/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA101.xsd" ::)
...
declare function xf:consultarReglasProvision_Req_CalcularProvTrama101Local($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:consultarReglasProvision_Req_CalcularProvTrama101Local($input_Parameters1)