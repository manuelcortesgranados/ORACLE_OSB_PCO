(:: pragma bea:global-element-parameter parameter="$wS_Result1" element="ns1:WS_Result" location="../../../Trama312/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA312.xsd" ::)
...
declare function xf:consultarReglasProvision_Req_CalcularProvTrama312Local($wS_Result1 as element(ns1:WS_Result),
    $tiempoI as xs:time)
...
xf:consultarReglasProvision_Req_CalcularProvTrama312Local($wS_Result1,
    $tiempoI)