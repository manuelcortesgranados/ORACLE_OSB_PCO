...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama412/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA412.xsd" ::)

declare namespace ns0 = "http://www.comcel.com.co/ConsultarReglasProvision/";
declare namespace ns1 = "http://www.comcel.com.co/CalcularProvisionTrama412/";
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglasProvision_Req_CalcularProvTrama412Local/";

declare function xf:consultarReglasProvision_Req_CalcularProvTrama412Local($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:consultarReglasProvision_Req_CalcularProvTrama412Local($input_Parameters1)
