(:: pragma bea:global-element-parameter parameter="$wS_Result1" element="ns1:WS_Result" location="../../../Trama704/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA704.xsd" ::)
...
declare function xf:consultarReglasProvision_Req_CalcularProvTrama704Local($wS_Result1 as element(ns1:WS_Result),
    $tiempoI as xs:time)
...
xf:consultarReglasProvision_Req_CalcularProvTrama704Local($wS_Result1,
    $tiempoI)