...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/ODM_BRMS_Res_Err_getSubscriberProductHistoryByMSISDN/";

declare function xf:ODM_BRMS_Res_Err_getSubscriberProductHistoryByMSISDN($codigo as xs:string)
...
xf:ODM_BRMS_Res_Err_getSubscriberProductHistoryByMSISDN($codigo)
