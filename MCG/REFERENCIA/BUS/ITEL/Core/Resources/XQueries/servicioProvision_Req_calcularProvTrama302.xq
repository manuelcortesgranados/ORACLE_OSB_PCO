...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama302/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA302.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/servicioProvision_Req_calcularProvTrama302/";
...
declare namespace ns1 = "http://www.comcel.com.co/CalcularProvisionTrama302/";
declare namespace ns0 = "http://www.comcel.com.co/OCS/OperacionCorbaOCS";

declare function xf:servicioProvision_Req_calcularProvTrama302($parametrosEntrada as element(*), $codigoIN as xs:string, $parametros as element(ns2:WS_Result),
    ...
    as element(ns1:Input_Parameters) {
       ...
       <TRAMA/>
				...
				<MIN_ELEGIDO>{data($parametrosEntrada/PARAMETROSPROVISION/PARAMETRO[NOMBRE='HOSTID']/VALOR/text())}</MIN_ELEGIDO>				
				<PARAMETROSTRAMA>
...
xf:servicioProvision_Req_calcularProvTrama302($parametrosEntrada , $codigoIN, $parametros, $consultarFaFListResponse, $datosOCS)