(:: pragma bea:global-element-parameter parameter="$wS_Result1" element="ns1:WS_Result" location="../../../Trama306/Resources/Schemas/PS_ITEL_CONSULTARREGLASTRAMA306.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglas_Res_Trama306/";

declare function xf:consultarReglas_Res_Trama306($wS_Result1 as element(ns1:WS_Result))
...
xf:consultarReglas_Res_Trama306($wS_Result1)