...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/ODM_BRMS_Res_getSubscriptionStatus/";

declare function xf:ODM_BRMS_Res_getSubscriptionStatus($wS_Result1 as element(ns1:WS_Result))
...
xf:ODM_BRMS_Res_getSubscriptionStatus($wS_Result1)
