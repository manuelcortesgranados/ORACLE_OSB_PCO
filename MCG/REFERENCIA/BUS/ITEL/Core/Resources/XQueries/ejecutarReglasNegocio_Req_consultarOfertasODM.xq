...
(:: pragma bea:global-element-return element="ns0:Input_Parameters" location="../../../OCS/AIR/Resources/Schemas/PS_ITEL_CONSULTAR_OFFER_ODM.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/ejecutarReglasNegocio_Req_consultarOfertasODM/";
...
declare function xf:ejecutarReglasNegocio_Req_consultarOfertasODM($input_Parameters1 as element(ns1:Input_Parameters))
    as element(ns0:Input_Parameters) {
        <ns0:Input_Parameters>
            ...
            <OFFERID_FIRST>{ "AIR" }</OFFERID_FIRST>
        </ns0:Input_Parameters>
};
...
xf:ejecutarReglasNegocio_Req_consultarOfertasODM($input_Parameters1)
