...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarContractTempContract_Error/";

declare function xf:consultarContractTempContract_Error($codigo as xs:string,
...
xf:consultarContractTempContract_Error($codigo,
    $mensaje,
    $descripcion)