...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarPlanesOCS_Error/";
declare namespace ns0 = "http://www.comcel.com.co/ConsultarPlanesOCS";

declare function xf:consultarPlanesOCS_Error($codigo as xs:string,
...
xf:consultarPlanesOCS_Error($codigo,
    $mensaje,
    $descripcion)