...
declare function xf:ODMJson_Res($resultCode as xs:string,
	...
	return
		concat("{",
			$quote, "AddSubscriptionResponse",$quote," : {",
				$quote, "resultCode",$quote," : {",xf:codigoError($resultCode),
				$quote, "subscriptionId",$quote," : ",$subscriptionId,
			"}",
		"}")				
};
