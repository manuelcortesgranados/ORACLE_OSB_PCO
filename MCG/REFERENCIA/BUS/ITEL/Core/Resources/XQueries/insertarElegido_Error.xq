...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/insertarElegido_Error/";
declare namespace ns0 = "http://www.comcel.com.co/PS_INSERTAR_ELEGIDO_ILIMITADO";

declare function xf:insertarElegido_Error($codigo as xs:string,
...
xf:insertarElegido_Error($codigo,
    $mensaje,
    $descripcion)