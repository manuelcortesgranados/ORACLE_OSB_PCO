(:: pragma bea:global-element-parameter parameter="$input_Parameters1" element="ns1:Input_Parameters" location="../Schemas/PS_ITEL_INSERTAR_AUDITORIARECARGADATOS.xsd" ::)
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../Schemas/BD_ITEL_INSERTARAUDITORIARECARGADATOS.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/insertarAuditoriaRecargaDatos_Req/";

declare function xf:insertarAuditoriaRecargaDatos_Req($input_Parameters1 as element(ns1:Input_Parameters))
...
xf:insertarAuditoriaRecargaDatos_Req($input_Parameters1)