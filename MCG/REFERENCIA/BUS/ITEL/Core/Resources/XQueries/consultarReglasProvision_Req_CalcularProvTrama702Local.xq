...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama702/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA702.xsd" ::)

declare namespace ns1 = "http://www.comcel.com.co/CalcularProvisionTrama702/";
declare namespace ns0 = "http://www.comcel.com.co/ConsultarReglasProvision/";
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglasProvision_Req_CalcularProvTrama702Local/";

declare function xf:consultarReglasProvision_Req_CalcularProvTrama702Local($input_Parameters1 as element(ns0:Input_Parameters))
    as element(ns1:Input_Parameters) {
        <ns1:Input_Parameters>
            ...
            <MIN_ELEGIDOS_REEMPLAZAR>{ data($input_Parameters1/PARAMETROSTRAMA/PARAMETRO[NOMBRE='DIASVIGENCIA']/VALOR) }</MIN_ELEGIDOS_REEMPLAZAR>
...
xf:consultarReglasProvision_Req_CalcularProvTrama702Local($input_Parameters1)