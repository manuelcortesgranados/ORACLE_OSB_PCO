...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama308/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA308.xsd" ::)

declare namespace ns1 = "http://www.comcel.com.co/CalcularProvisionTrama308/";
declare namespace ns0 = "http://www.comcel.com.co/ConsultarReglasProvision/";
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglasProvision_Req_CalcularProvTrama308Local/";

declare function xf:consultarReglasProvision_Req_CalcularProvTrama308Local($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:consultarReglasProvision_Req_CalcularProvTrama308Local($input_Parameters1)