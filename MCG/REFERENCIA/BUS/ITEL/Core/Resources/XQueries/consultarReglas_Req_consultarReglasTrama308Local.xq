...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama308/Resources/Schemas/PS_ITEL_CONSULTARREGLASTRAMA308.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglas_Req_consultarReglasTrama308Local/";

declare function xf:consultarReglas_Req_consultarReglasTrama308Local($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:consultarReglas_Req_consultarReglasTrama308Local($input_Parameters1)