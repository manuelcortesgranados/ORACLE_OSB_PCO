...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/servicioProvision_Req_UpdateAccumulator/";

declare function xf:servicioProvision_Req_UpdateAccumulator($input_Parameters1 as element(ns0:Input_Parameters))
    as element(ns2:Input_Parameters) {
        <ns2:Input_Parameters>
            ...
            <ACCUMULATOR_UPDATE_INFORMATION>
                ...
                <ACCUMULATORID>{ fn:tokenize(data($input_Parameters1/PARAMETROSPROVISION/PARAMETRO[NOMBRE="PAQUETERTC"]/VALOR), ";")[2] }</ACCUMULATORID>
            </ACCUMULATOR_UPDATE_INFORMATION>
        </ns2:Input_Parameters>
};
...
xf:servicioProvision_Req_UpdateAccumulator($input_Parameters1)
