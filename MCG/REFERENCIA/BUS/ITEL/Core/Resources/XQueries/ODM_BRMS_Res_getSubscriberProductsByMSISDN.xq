...
(:: pragma bea:global-element-return element="ns0:getSubscriberProductsByMSISDNResponse" location="../WSDLs/Odm_BRMSWebService.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/ODM_BRMS_Res_getSubscriberProductsByMSISDN/";

declare function xf:ODM_BRMS_Res_getSubscriberProductsByMSISDN($wS_Result1 as element(ns1:WS_Result))
    as element(ns0:getSubscriberProductsByMSISDNResponse) {
        <ns0:getSubscriberProductsByMSISDNResponse>
            {
...
xf:ODM_BRMS_Res_getSubscriberProductsByMSISDN($wS_Result1)
