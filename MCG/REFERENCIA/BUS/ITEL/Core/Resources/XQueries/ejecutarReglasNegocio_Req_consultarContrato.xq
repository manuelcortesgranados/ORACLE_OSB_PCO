...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/ejecutarReglasNegocio_Req_consultarContrato/";
declare namespace ns0 = "http://www.comcel.com.co/ConsultarContract";

declare function xf:ejecutarReglasNegocio_Req_consultarContrato($tmcode as xs:string,
    $spcode as xs:string)
...
xf:ejecutarReglasNegocio_Req_consultarContrato($tmcode,
    $spcode)