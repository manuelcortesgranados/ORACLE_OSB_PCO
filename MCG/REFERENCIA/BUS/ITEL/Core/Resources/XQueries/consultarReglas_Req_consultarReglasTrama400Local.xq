...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama400/Resources/Schemas/PS_ITEL_CONSULTARREGLASTRAMA400.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglas_Req_consultarReglasTrama400Local/";

declare function xf:consultarReglas_Req_consultarReglasTrama400Local($input_Parameters1 as element(ns0:Input_Parameters))
            ...
            <HEADER>
                ...
                <MIN>{ data($input_Parameters1/MIN_DESTINO) }</MIN>
                    ...
                    <PARAMETERS>
                    	...
                    	<HASUNLIMITEDCHOSEN>{
                    	    if(exists(data($input_Parameters1/PARAMETROS/PARAMETRO[NOMBRE = 'ELEGIDOSACTIVOS']/VALOR))) then
								data($input_Parameters1/PARAMETROS/PARAMETRO[NOMBRE = 'ELEGIDOSACTIVOS']/VALOR)
							else
								"false"                    	    
                    	}</HASUNLIMITEDCHOSEN>                    	
                    </PARAMETERS>
...
xf:consultarReglas_Req_consultarReglasTrama400Local($input_Parameters1)