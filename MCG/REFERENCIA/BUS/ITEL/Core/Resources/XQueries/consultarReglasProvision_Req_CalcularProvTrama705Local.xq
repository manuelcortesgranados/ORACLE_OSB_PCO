...
declare function xf:consultarReglasProvision_Req_CalcularProvTrama705Local($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:consultarReglasProvision_Req_CalcularProvTrama705Local($input_Parameters1)