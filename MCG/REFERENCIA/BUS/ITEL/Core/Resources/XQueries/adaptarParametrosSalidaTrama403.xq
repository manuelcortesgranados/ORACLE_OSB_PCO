...
declare function xf:adaptarParametrosSalidaTrama400($reglasNegocioResponse as element(ns2:WS_Result))
    as xs:string {
        ...
        concat($montoRecarga
        	...
        	, ";"
        	, xf:expirationDate(data($suscriptorDestino/*:BonusAccountID/*:ExpiryDate), if(data($parametrosReglas/PARAMETRO[NOMBRE='VIGENCIABONOS']/VALOR) = "" or $montoBonos = 0) then 0 else data($parametrosReglas/PARAMETRO[NOMBRE='VIGENCIABONOS']/VALOR))
        	, ";"
