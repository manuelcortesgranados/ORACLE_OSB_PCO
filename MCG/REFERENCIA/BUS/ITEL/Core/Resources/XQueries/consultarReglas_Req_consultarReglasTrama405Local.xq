...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama405/Resources/Schemas/PS_ITEL_CONSULTARREGLASTRAMA405.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglas_Req_consultarReglasTrama405Local/";

declare function xf:consultarReglas_Req_consultarReglasTrama405Local($input_Parameters1 as element(ns0:Input_Parameters))
            ...
            <HEADER>
                ...
                <MIN>{ data($input_Parameters1/MIN_DESTINO) }</MIN>
                    ...
                    <PARAMETERS>
                    	...
                    	<MONTODEBITO>{data($input_Parameters1/PARAMETROS/PARAMETRO[NOMBRE = 'MONTORECARGA']/VALOR)}</MONTODEBITO>
...
xf:consultarReglas_Req_consultarReglasTrama405Local($input_Parameters1)