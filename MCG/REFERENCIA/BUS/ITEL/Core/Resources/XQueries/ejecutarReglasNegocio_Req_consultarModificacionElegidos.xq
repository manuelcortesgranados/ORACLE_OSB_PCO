...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/ejecutarReglasNegocio_Req_consultarModificacionElegidos/";

declare function xf:ejecutarReglasNegocio_Req_consultarModificacionElegidos($min as xs:string)
...
xf:ejecutarReglasNegocio_Req_consultarModificacionElegidos($min)