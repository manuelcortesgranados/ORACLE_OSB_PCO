(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns1:OutputParameters" location="../Schemas/BD_ITEL_CONSULTAR_VIG_ELEGIDO_FIJO.xsd" ::)
...
declare function xf:consultarVigenciaElegidoFijo_Res($outputParameters1 as element(ns1:OutputParameters))
...
xf:consultarVigenciaElegidoFijo_Res($outputParameters1)