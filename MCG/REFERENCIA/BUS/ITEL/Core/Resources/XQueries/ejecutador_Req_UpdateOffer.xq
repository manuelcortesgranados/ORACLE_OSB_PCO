...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/ejecutador_Req_UpdateOffer/";
...
declare function xf:ejecutador_Req_UpdateOffer($input_Parameters1 as element(ns0:Input_Parameters))
    as element(ns2:Input_Parameters) {
        <ns2:Input_Parameters>
            ...
            <OFFER_ID>{ fn:tokenize(data($input_Parameters1/PARAMETROS_TRAMA/PARAMETRO[NOMBRE="PAQUETERTC"]/VALOR), ";")[1] }</OFFER_ID>
...
xf:ejecutador_Req_UpdateOffer($input_Parameters1)
