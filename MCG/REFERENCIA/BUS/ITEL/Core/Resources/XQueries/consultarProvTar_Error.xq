...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarProvTar_Error/";

declare function xf:consultarProvTar_Error($codigo as xs:string,
...
xf:consultarProvTar_Error($codigo,
    $mensaje,
    $descripcion)