(:: pragma bea:global-element-parameter parameter="$wS_Result1" element="ns1:WS_Result" location="../../../Trama310/Resources/Schemas/PS_ITEL_CONSULTARREGLASTRAMA310.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglas_Res_Trama310/";

declare function xf:consultarReglas_Res_Trama310($wS_Result1 as element(ns1:WS_Result))
...
xf:consultarReglas_Res_Trama310($wS_Result1)