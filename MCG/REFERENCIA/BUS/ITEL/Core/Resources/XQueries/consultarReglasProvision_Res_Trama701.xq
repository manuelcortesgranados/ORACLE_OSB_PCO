(:: pragma bea:global-element-parameter parameter="$wS_Result1" element="ns1:WS_Result" location="../../../Trama701/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA701.xsd" ::)
...
declare function xf:consultarReglasProvision_Req_CalcularProvTrama701Local($wS_Result1 as element(ns1:WS_Result),
    $tiempoI as xs:time)
...
xf:consultarReglasProvision_Req_CalcularProvTrama701Local($wS_Result1,
    $tiempoI)