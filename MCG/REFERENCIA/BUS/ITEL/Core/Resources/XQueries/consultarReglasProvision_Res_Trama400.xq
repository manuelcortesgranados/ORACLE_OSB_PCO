(:: pragma bea:global-element-parameter parameter="$wS_Result1" element="ns1:WS_Result" location="../../../Trama400/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA400.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglasProvision_Req_CalcularProvTrama400Local/";

declare function xf:consultarReglasProvision_Req_CalcularProvTrama400Local($wS_Result1 as element(ns1:WS_Result),
    $tiempoI as xs:time)
...
xf:consultarReglasProvision_Req_CalcularProvTrama400Local($wS_Result1,
    $tiempoI)