...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama410/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA410.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglasProvision_Req_CalcularProvTrama410Local/";

declare function xf:consultarReglasProvision_Req_CalcularProvTrama410Local($input_Parameters1 as element(ns0:Input_Parameters))
...
xf:consultarReglasProvision_Req_CalcularProvTrama410Local($input_Parameters1)