...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarPaquetesTAT_Error/";

declare function xf:consultarPaquetesTAT_Error($codigo as xs:string,
...
xf:consultarPaquetesTAT_Error($codigo,
    $mensaje,
    $descripcion)