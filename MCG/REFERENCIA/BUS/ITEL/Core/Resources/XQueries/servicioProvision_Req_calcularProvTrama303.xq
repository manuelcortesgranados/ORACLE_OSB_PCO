...
(:: pragma bea:global-element-return element="ns1:Input_Parameters" location="../../../Trama303/Resources/Schemas/PS_ITEL_CALCULARPROVISIONTRAMA303.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/servicioProvision_Req_calcularProvTrama303/";
declare namespace ns2 = "http://www.comcel.com.co/ConsultarReglas/";
declare namespace ns1 = "http://www.comcel.com.co/CalcularProvisionTrama303/";
declare namespace ns0 = "http://www.comcel.com.co/OCS/OperacionCorbaOCS";

declare function xf:servicioProvision_Req_calcularProvTrama303($parametrosEntrada as element(*), $codigoIN as xs:string, $parametros as element(ns2:WS_Result))
...
xf:servicioProvision_Req_calcularProvTrama303($parametrosEntrada , $codigoIN, $parametros)