...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/adaptarParametrosSalidaTrama408/";
...
declare function xf:adaptarParametrosSalidaTrama408($reglasNegocioResponse as element(ns2:WS_Result))
    as xs:string {
...
xf:adaptarParametrosSalidaTrama408($reglasNegocioResponse)