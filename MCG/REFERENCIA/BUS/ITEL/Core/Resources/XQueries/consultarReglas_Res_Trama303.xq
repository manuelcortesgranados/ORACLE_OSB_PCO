(:: pragma bea:global-element-parameter parameter="$wS_Result1" element="ns1:WS_Result" location="../../../Trama303/Resources/Schemas/PS_ITEL_CONSULTARREGLASTRAMA303.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarReglas_Res_Trama303/";

declare function xf:consultarReglas_Res_Trama303($wS_Result1 as element(ns1:WS_Result))
    as element(ns0:WS_Result) {
        <ns0:WS_Result>
            ...
            <MENSAJE>
                ...
                <PARAMETROS>
                    <PARAMETRO>
                        <NOMBRE>{fn:node-name($wS_Result1/MENSAJE/FECHA_RENOVACION_ILIMITADO)}</NOMBRE>
                        <TIPO>string</TIPO>
                        <VALOR>{data($wS_Result1/MENSAJE/FECHA_RENOVACION_ILIMITADO) }</VALOR>
                    </PARAMETRO>
                    <PARAMETRO>
...
xf:consultarReglas_Res_Trama303($wS_Result1)