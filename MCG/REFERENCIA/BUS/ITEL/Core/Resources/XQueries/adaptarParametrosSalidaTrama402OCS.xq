...
declare function xf:adaptarParametrosSalidaTrama402($monto as xs:string, $diasVigencia as xs:string, $wS_Result1 as element(ns0:WS_Result), $contrato, $cuentasDA)
    as xs:string {
...
xf:adaptarParametrosSalidaTrama402($monto, $diasVigencia, $wS_Result1, $contrato, $cuentasDA)