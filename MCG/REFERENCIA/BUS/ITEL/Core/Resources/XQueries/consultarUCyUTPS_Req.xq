...
declare namespace xf = "http://tempuri.org/ITEL/Core/Resources/XQueries/consultarUCyUTPS_Req/";
...
declare function xf:consultarUCyUTPS_Req($min as xs:string)
