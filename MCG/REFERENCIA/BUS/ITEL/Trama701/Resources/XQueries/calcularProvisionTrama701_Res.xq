...
(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision1" element="ns1:callFunctionStatelessDecision" location="../WSDLs/trama701Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA701.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Trama701/Resources/XQueries/calcularProvisionTrama701_Res/";

declare function xf:calcularProvisionTrama701_Res($callFunctionStatelessDecision1 as element(ns1:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama701_Res($callFunctionStatelessDecision1)