...
(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision1" element="ns2:callFunctionStatelessDecision" location="../WSDLs/trama501Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns1:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA501.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/Trama501/Resources/XQueries/calcularProvisionTrama501_Res/";
...
declare function xf:calcularProvisionTrama501_Res($callFunctionStatelessDecision1 as element(ns2:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama501_Res($callFunctionStatelessDecision1)