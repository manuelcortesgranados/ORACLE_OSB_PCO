...
(:: pragma bea:global-element-parameter parameter="$input_Parameters1" element="ns3:Input_Parameters" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA307.xsd" ::)
(:: pragma bea:global-element-return element="ns1:callFunctionStateless" location="../WSDLs/trama307Provision_DB.wsdl" ::)

declare namespace xf = "http://tempuri.org/ITEL/Trama307/Resources/XQueries/calcularProvisionTrama307_Req/";
...
declare namespace ns3 = "http://www.comcel.com.co/CalcularProvisionTrama307/";
...
declare function xf:getSuscriptorDataOCS($input_Parameters1 as element(ns3:Input_Parameters))
{
	<ns0:SUSCRIPTOR>
     	...
     	<ns0:ISSERVICEACTIVE>false</ns0:ISSERVICEACTIVE>
     	<ns0:HASUNLIMITEDCHOSEN>false</ns0:HASUNLIMITEDCHOSEN>
     	<ns0:HASFIRSTCHOSEN>false</ns0:HASFIRSTCHOSEN>
...
declare function xf:cargaElegidos($elegidos as xs:string)
 {
		...
		then "" 
		else <ns0:Detail>{fn:normalize-space($min)}</ns0:Detail>
};

declare function xf:calcularProvisionTrama307_Req($input_Parameters1 as element(ns3:Input_Parameters))
    as element(ns1:callFunctionStateless) {
        <ns1:callFunctionStateless name="Trama307Provision_DF_Trama307Provision">
            <ns1:parameterList>
                <ns0:TRAMA_EJECUCION>
...
xf:calcularProvisionTrama307_Req($input_Parameters1)