...
(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision1" element="ns0:callFunctionStatelessDecision" location="../WSDLs/trama306Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA306.xsd" ::)

declare namespace xf = "http://tempuri.org/ITEL/Trama306/Resources/XQueries/calcularProvisionTrama306_Res/";
...
declare function xf:calcularProvisionTrama306_Res($callFunctionStatelessDecision1 as element(ns0:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama306_Res($callFunctionStatelessDecision1)