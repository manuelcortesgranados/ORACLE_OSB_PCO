(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision" element="ns0:callFunctionStatelessDecision" location="../WSDLs/trama412Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA412.xsd" ::)
...
declare namespace ns0 = "http://xmlns.oracle.com/Trama412Provision/Trama412Provision_DF_Trama412Provision";
declare namespace xf = "http://tempuri.org/ITEL/Trama412/Resources/XQueries/calcularProvisionTrama412_Res/";

declare function xf:calcularProvisionTrama412_Res($callFunctionStatelessDecision as element(ns0:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama412_Res($callFunctionStatelessDecision)