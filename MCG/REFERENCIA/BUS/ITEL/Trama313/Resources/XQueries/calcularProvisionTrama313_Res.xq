(:: pragma bea:global-element-parameter parameter="$callFunctionStatelessDecision1" element="ns1:callFunctionStatelessDecision" location="../WSDLs/trama313Provision_DB.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:WS_Result" location="../Schemas/PS_ITEL_CALCULARPROVISIONTRAMA313.xsd" ::)
...
declare namespace xf = "http://tempuri.org/ITEL/Trama313/Resources/XQueries/calcularProvisionTrama313_Res/";

declare function xf:calcularProvisionTrama313_Res($callFunctionStatelessDecision1 as element(ns1:callFunctionStatelessDecision))
...
xf:calcularProvisionTrama313_Res($callFunctionStatelessDecision1)